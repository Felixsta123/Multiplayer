...
struct FVoxelTerrainSettings
{
    ...
    // Option pour les bâtiments en escalier
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Terrain|Buildings")
    bool bGenerateStairsBuildings = false;

    // Nombre de bâtiments en escalier à générer
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Terrain|Buildings", meta = (ClampMin = "0", ClampMax = "10", EditCondition = "bGenerateStairsBuildings"))
    int32 NumberOfStairsBuildings = 1;
    ...
    void Validate()
    {
        ...
        // Limiter le nombre de bâtiments en escalier
        NumberOfStairsBuildings = FMath::Clamp(NumberOfStairsBuildings, 0, 10);
